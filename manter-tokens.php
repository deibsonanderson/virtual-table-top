						...
						while ($token = $diretorio->read()) {
							if ($token != '.' && $token != '..') {
								...
								<tr>
									...
									<td>
										<button type="button" class="obr-btn obr-btn-danger" style="padding: 4px 10px; font-size: 12px;" onclick="removerItem('./<?php echo $pagina; ?>?pic=<?php echo $token; ?>')"><i class="fa-solid fa-trash"></i> remover</button>
									</td>
								</tr>
								<?php
							}
